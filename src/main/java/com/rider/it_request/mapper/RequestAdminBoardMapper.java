...
import com.rider.it_request.dto.RequestStatusHistoryDTO;
import com.rider.it_request.entity.*;
import com.rider.it_request.repository.*;
...
public class RequestAdminBoardMapper {
    ...
    public RequestHistoryAdminBoardDTO toDTOHistory(Request request) {
        ...
        Optional<User> ChangedBy = userRepository.findById(request.getUserId());
