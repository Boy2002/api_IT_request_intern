...
public class RequestDTO {
    ...
    @NotNull(message = "User is required") private int userId; // ใช้ id ของ User แทนการใช้ User object

    @NotNull(message = "Category is required") private int categoryId; // ใช้ id ของ Category แทนการใช้ Category object
